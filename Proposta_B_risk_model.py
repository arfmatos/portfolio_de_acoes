...
from tensorflow.keras.layers import MaxPooling1D, Conv1D, TimeDistributed
...
class Model:
    ...
    def __build_model(self, input_shapes, outputs):
        ...
        def sharpe_loss(_, y_pred):
            # fazer todas as séries temporais começarem em 1
            data = tf.divide(self.data, self.data[0])  
                
            # valor da carteira após as alocações aplicadas
            ...
            # já que queremos maximizar Sharpe, enquanto a descida do gradiente minimiza a perda,
            # podemos negar Sharpe (o mínimo de uma função negada é seu máximo)
            return -sharpe
